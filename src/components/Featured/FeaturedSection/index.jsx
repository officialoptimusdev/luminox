  ...
  return (
    <section className="w-full overflow-hidden">
      {sections.map((section, idx) => {
        ...
        return (
          <AnimatePresence key={section.tagline}>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            >
              {/* CONTAINER BOX */}
              <div className="max-w-7xl mx-auto px-0 relative z-10 mb-9">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-8 items-center gap-0 lg:gap-16 mb-4">
                  {/* IMAGE SIDE */}
                  <div
                  ...
                  >
                    ...
                    <div className="relative space-y-4">
                      ...
                      {section.buttonText && (
                        <Button
                          variant="default"
                          className="rounded-full flex items-center gap-2 px-6 py-3"
                          onClick={() => {
                            if (section.href) {
