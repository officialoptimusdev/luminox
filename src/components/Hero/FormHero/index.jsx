...
import { formHeroData } from "@/constants/data";
import { Link } from "react-router-dom";

export default function FormHero({
  icon = formHeroData.icon,
  label = formHeroData.label,
  title = formHeroData.title,
  description = formHeroData.description,
  buttonText = formHeroData.buttonText,
  imageDesktop = formHeroData.imageDesktop,
  imageMobile = formHeroData.imageMobile,
}) {
